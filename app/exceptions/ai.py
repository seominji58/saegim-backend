...
class AITokenLimitExceededException(AIServiceException):
    ...
    def __init__(self, used_tokens: int, limit_tokens: int, user_id: str | None = None):
        ...
        super().__init__(
            status_code=429, detail=detail, error_code="AI_TOKEN_LIMIT_EXCEEDED"
        )
...
class AIGenerationFailedException(AIServiceException):
    ...
    def __init__(
        ...
        super().__init__(
            status_code=500, detail=detail, error_code="AI_GENERATION_FAILED"
        )
...
class RegenerationLimitExceededException(AIRateLimitExceededException):
    ...
    def __init__(
        self, current_count: int, max_count: int = 5, session_id: str | None = None
    ):
...
class SessionNotFoundException(AIServiceException):
    ...
    def __init__(self, session_id: str):
        ...
        super().__init__(status_code=404, detail=detail, error_code="SESSION_NOT_FOUND")


class InvalidRequestException(BusinessException):
    """잘못된 요청 예외"""

    def __init__(self, detail: str = "잘못된 요청입니다.", field: str | None = None):
        self.field = field

        super().__init__(status_code=400, detail=detail, error_code="INVALID_REQUEST")
